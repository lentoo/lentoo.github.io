...
// Data from user's image (Sep 2025)
const rawData = [
  { symbol: 'BABA', realized: 298.28, unrealized: 0 },
  { symbol: 'INTC', realized: 376.34, unrealized: 0 },
  { symbol: 'TLT', realized: 389.76, unrealized: 0 },
  { symbol: 'AAPL', realized: 425.64, unrealized: 0 },
  { symbol: 'SMR', realized: -363.64, unrealized: 0 },
  { symbol: 'NVDA', realized: 362.81, unrealized: 0 },
  { symbol: 'TSLA', realized: 112.59, unrealized: 0 },
  { symbol: 'TMF', realized: 139.54, unrealized: 0 },
  { symbol: 'GLD', realized: 211.48, unrealized: 0 },
  { symbol: 'SLV', realized: 159.58, unrealized: 0 },
  { symbol: 'UNH', realized: -47.11, unrealized: 0 },
  { symbol: 'USO', realized: -53.7, unrealized: 0 },
];
