...
// Data from user's image (August 2025)
const rawData = [
  { symbol: 'META', realized: 91.0, unrealized: 0 },
  { symbol: 'INTC', realized: 32.0, unrealized: 136 }, // Realized from put, unrealized from new spread
  { symbol: 'BABA', realized: 106.0, unrealized: 0 },
  { symbol: 'LMT', realized: 34.09, unrealized: 0 },
  { symbol: 'YINN', realized: 30.0, unrealized: 0 },
  { symbol: 'AMD', realized: 155.52, unrealized: 0 },
  { symbol: 'IBKR', realized: 0, unrealized: 130 },
  { symbol: 'AAPL', realized: 0, unrealized: 897 },
  { symbol: 'UNH', realized: 0, unrealized: 250 },
  { symbol: 'GLD', realized: 0, unrealized: 302 },
];
...
// Note: Unrealized here is just credit received for open options
